...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.modeltype == "stolen":
        ...
        logname = f"testing{args.datasetsteal}{args.num_queries}{args.losstype}{args.dataset}_defence_{args.usedefence}_sybil_{args.n_sybils}_alpha{args.alpha}_beta{args.beta}_lambda{args.lam}_repeat_times_{args.repeat_times}_noise_threshold_{args.noise_threshold}.log"
    ...
    if args.modeltype == "stolen":
        checkpoint = torch.load(
            f"{args.pathpre}/{args.model_to_steal}/checkpoint_imagenet_infonce_{args.num_queries}_defence_{args.usedefence}_sybil_{args.n_sybils}_alpha{args.alpha}_beta{args.beta}_lambda{args.lam}_repeat_times_{args.repeat_times}_noise_threshold_{args.noise_threshold}.pth.tar",
            map_location="cpu",
        )
        state_dict = checkpoint["state_dict"]
        print("state_dict")
